...
public static class AdventureLogCatalog
{
    ...
    public static readonly MercEntry[] Mercs =
    {
        ...
        Hire("H016", "杜根", "怒角", "kuangzhan101", "狂战士", "完成新手引导后酒馆可招募", "酒馆",
            "红角比布罗克短一截、嗓门却大两倍的狂战士。",
            "他自称‘无声猎手’，但开战前的吼声能让仙泉结冰。"),
        Hire("H017", "莉娜", "圣光", "naima101", "牧师", "完成新手引导后酒馆可招募", "酒馆",
            "金发白衣牧师，治疗时嘴里念念有词。",
    ...
    public static readonly StoryEntry[] Main =
    {
        new StoryEntry
        {
            ...
            Summary = "玩家加入冒险者公会，会长派发森林层委托。老盾作为临时队友入队，咨询台小姐传授三条下裂缝规则。",
