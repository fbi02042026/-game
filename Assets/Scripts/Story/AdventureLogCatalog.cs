...
public static class AdventureLogCatalog
{
    ...
    {
        // —— 暮影森林（第一章）——
        M("M001", "走路菇", "forest_101", "普通", "暮影森林·普通关", "首次遭遇",
            "黄色小蘑菇，靠两根短腿一蹦一跳移动。据说它自己也不知道为什么要追人。",
            "老猎人格雷说：‘这玩意儿烤了能吃，但吃了会看见会长在跳舞。’没人敢验证。"),
        M("M002", "毒伞菇", "forest_102", "普通", "暮影森林·普通关", "首次击败",
            "绿色蘑菇，伞盖上长了斑点。走路不稳，但脾气很稳——一直很坏。",
            "公会食堂曾把它当蔬菜收过，结果当天全员请假。咨询台小姐至今不解释。"),
        M("M003", "红浆果怪", "forest_103", "普通", "暮影森林·普通关", "首次遭遇",
            "一丛长眼睛的红色浆果，滚起来像颗愤怒的水果。",
            "冒险者之间打赌：谁吃它一口，谁下顿饭请客。目前没人赢过。"),
        M("M004", "森林史莱姆", "forest_104", "普通", "暮影森林·普通关", "首次击败",
            "绿色半透明胶状物，撞到人会发出“咕叽”一声。",
            "它的身体 90% 是水分，剩下 10% 是对你的不满。"),
        M("M005", "硬壳甲虫", "forest_105", "普通", "暮影森林·普通关", "首次击败",
            "橙色大甲虫，背甲硬到能当平底锅用。",
            "营地传说：用它的壳煎蛋，蛋会自己站起来逃跑。"),
        M("M006", "刺毛兽", "forest_106", "精英", "暮影森林·精英关", "首次遭遇",
            "白色刺猬状野兽，背上长满尖刺，生气时会炸毛。",
            "别摸。上次有人摸了一下，三天后还在从手套里拔刺。"),
        M("M007", "赤甲蟹", "forest_107", "精英", "暮影森林·精英关", "首次击败",
            "红色甲壳生物，两只钳子一大一小，看起来不太协调。",
            "它总把大钳子当锤子用，小钳子当牙签用。没人知道它从哪学来的。"),
        M("M008", "冰晶虫", "forest_108", "普通", "暮影森林·普通关", "首次遭遇",
            "蓝色结晶小虫，体内封存着一丝寒气。",
            "森林层明明不冷，但它走到哪都自带空调。老盾很爱站在它旁边乘凉。"),
        M("M009", "食人花苞", "forest_109", "普通", "暮影森林·普通关", "首次击败",
            "绿色食肉植物，嘴巴一直张着，像在等人喂它。",
            "它其实不是吃人，只是嘴巴合不上。但你要把手伸进去，它也乐意配合。"),
        M("M010", "岩块傀儡", "forest_110", "精英", "暮影森林·精英关", "首次击败",
            "由碎石和苔藓拼成的人形怪物，动作缓慢但血量惊人。",
            "传闻它是某个迷路石匠的杰作。石匠后来成了它的晚饭。"),
        M("M011", "巨型食人花", "forest_111", "首领", "暮影森林·首领关", "首次击败",
            "大型食肉植物，花瓣边缘呈锯齿状，会喷吐酸液。",
            "森林里的怪物都叫它‘大姐头’，虽然没人确认过它的性别。"),
        M("M012", "森之守护者", "forest_112", "首领", "暮影森林·首领关", "首次击败",
            "沉睡于石碑之后的古老树灵，既是森林的意志，也是裂隙侵蚀的第一个牺牲品。",
            "它原本守护着每一棵树。现在它只能守护自己的疯狂。"),

        // —— 雨林遗迹（第二章）——
        Later("M101", "跳跳蛙", "jungle_301", "普通", "雨林遗迹·普通关",
            "跳得比见习冒险者跑得还快，但总是跳进自己同伴怀里。"),
        Later("M102", "毒箭蛙", "jungle_302", "普通", "雨林遗迹·普通关",
            "雨林原住民把它当染料用，直到有人染成了绿色。"),
        Later("M103", "藤蔓蛇", "jungle_303", "普通", "雨林遗迹·普通关",
            "它其实不是想咬你，只是想借你的体温暖和一下。"),
        Later("M104", "孢子蝠", "jungle_304", "普通", "雨林遗迹·普通关",
            "被孢子呛到的人会打喷嚏，连打七个，老盾数过。"),
        Later("M105", "泥潭蟹", "jungle_305", "普通", "雨林遗迹·普通关",
            "它夹什么取决于前一天吃了什么。"),
        Later("M106", "食虫花", "jungle_306", "普通", "雨林遗迹·普通关",
            "老盾曾把糖水涂在盾牌上测试它，洗了一下午。"),
        Later("M107", "雨林史莱姆", "jungle_307", "普通", "雨林遗迹·普通关",
            "它的座右铭是：你是什么，我就是什么的一部分。"),
        Later("M108", "巨颚蚁", "jungle_308", "精英", "雨林遗迹·精英关",
            "它们排队搬家时，新手常误以为是条路。"),
        Later("M109", "毒蛇藤", "jungle_309", "精英", "雨林遗迹·精英关",
            "很多新手把它当绳子爬过，结局都不太体面。"),
        Later("M110", "沼泽鳄", "jungle_310", "精英", "雨林遗迹·精英关",
            "它等猎物耐心十足，等开饭也一样。"),
        Later("M111", "雨林巨蟒", "jungle_311", "首领", "雨林遗迹·首领关",
            "它把自己绕成迷宫，结果自己也不记得尾巴在哪。"),
        Later("M112", "遗迹花后", "jungle_312", "首领", "雨林遗迹·首领关",
            "它之所以巨大，是因为从来没人敢告诉它该减肥。"),

        // —— 亡者墓地（第三章）——
        Later("M201", "骷髅兵", "undead_201", "普通", "亡者墓地·普通关",
            "生前是公会会计，死后还在数金币。你打死它，它掉的是铜板。"),
        Later("M202", "僵尸农夫", "undead_202", "普通", "亡者墓地·普通关",
            "总在问‘我的锄头呢’，但其实它早把锄头当武器抡你了。"),
        Later("M203", "幽灵学徒", "undead_203", "普通", "亡者墓地·普通关",
            "它生前魔法考试不及格，死后依然放不出火球。"),
        Later("M204", "腐肉犬", "undead_204", "普通", "亡者墓地·普通关",
            "它追你的原因可能是你昨晚吃了肉干。"),
        Later("M205", "游魂", "undead_205", "普通", "亡者墓地·普通关",
            "它只是想找个人说话，但没人听得懂。"),
        Later("M206", "骷髅弓箭手", "undead_206", "普通", "亡者墓地·普通关",
            "它射出的箭都是自己骨头做的，射一根少一根。"),
        Later("M207", "瘟疫鼠", "undead_207", "普通", "亡者墓地·普通关",
            "它不是故意散播瘟疫，只是毛掉得厉害。"),
        Later("M208", "幽灵会计", "undead_208", "精英", "亡者墓地·精英关",
            "死后掉的账本比装备还多。老盾说它的字比会长还难认。"),
        Later("M209", "无头骑士", "undead_209", "精英", "亡者墓地·精英关",
            "它最大的烦恼是下雨时脑袋会进水。"),
        Later("M210", "死灵法师", "undead_210", "精英", "亡者墓地·精英关",
            "它其实想复活自己，结果每次都复活出一只青蛙。"),
        Later("M211", "骸骨领主", "undead_211", "首领", "亡者墓地·首领关",
            "它觉得自己是王，但连个能坐的椅子都没有。"),
        Later("M212", "骨龙幼崽", "undead_212", "首领", "亡者墓地·首领关",
            "它觉得自己很可怕，直到一只猫对着它打了个哈欠。"),

        // —— 海岛沉船（第四章）——
        Later("M301", "海盐蟹", "sea_501", "普通", "海岛沉船·普通关",
            "它夹你的力气取决于今天潮水大不大。"),
        Later("M302", "刺尾鱼", "sea_502", "普通", "海岛沉船·普通关",
            "它们的队伍像一把梳子，把海水梳得哗哗响。"),
        Later("M303", "铁甲蟹", "sea_503", "普通", "海岛沉船·普通关",
            "壳硬到能挡箭，但翻过来就再也翻不回去。这是它的秘密。"),
        Later("M304", "海藻怪", "sea_504", "普通", "海岛沉船·普通关",
            "它只是想上岸晒晒太阳，但你打断了它的假期。"),
        Later("M305", "灯笼水母", "sea_505", "普通", "海岛沉船·普通关",
            "发光是为了吸引猎物，但常常吸引来的是另一只灯笼水母。"),
        Later("M306", "潮汐史莱姆", "sea_506", "普通", "海岛沉船·普通关",
            "退潮时它会缩小一半，像一块漏气的垫子。"),
        Later("M307", "海盗幽灵", "sea_507", "普通", "海岛沉船·普通关",
            "它说的藏宝地点每次都不一样，老盾怀疑它根本记不住。"),
        Later("M308", "深海章鱼", "sea_508", "精英", "海岛沉船·精英关",
            "它其实只有七条触手，第八条被它自己吃掉了。"),
        Later("M309", "暴风雨海鸥", "sea_509", "精英", "海岛沉船·精英关",
            "它不是生气，只是静电太多，碰一下会炸毛。"),
        Later("M310", "贝壳精", "sea_510", "精英", "海岛沉船·精英关",
            "它把壳当成房子，房贷还了五十年。"),
        Later("M311", "沉船船长", "sea_511", "首领", "海岛沉船·首领关",
            "他下令全船陪葬，结果自己先忘了为什么。"),
        Later("M312", "克拉肯触须", "sea_512", "首领", "海岛沉船·首领关",
            "船员打赌它有多长，目前没人看到尽头。"),

        // —— 晨曦草原（第五章）——
        Later("M401", "绿史莱姆", "field_401", "普通", "晨曦草原·普通关",
            "普通史莱姆的梦想是变大，最后都变成了别人的经验。"),
        Later("M402", "红史莱姆", "field_402", "普通", "晨曦草原·普通关",
            "它变红不是因为愤怒，是因为吃了太多辣椒。"),
        Later("M403", "跳跳兔", "field_403", "普通", "晨曦草原·普通关",
            "它跳起来比你跑得快，但落地时常常崴脚。"),
        Later("M404", "稻草人", "field_404", "普通", "晨曦草原·普通关",
            "农民说它能吓跑乌鸦，结果乌鸦学会了放火。"),
        Later("M405", "田鼠", "field_405", "普通", "晨曦草原·普通关",
            "它偷的麦子够开一家面包店，但它只囤不吃。"),
        Later("M406", "风精灵", "field_406", "普通", "晨曦草原·普通关",
            "它说话声音很轻，老盾以为那是耳鸣。"),
        Later("M407", "野狼", "field_407", "普通", "晨曦草原·普通关",
            "月圆之夜它们会嚎叫，但平原没有月亮，它们只是跟风车较劲。"),
        Later("M408", "狂暴野狼", "field_408", "精英", "晨曦草原·精英关",
            "它被狼群赶了出来，所以把气撒在你身上。"),
        Later("M409", "风车巨人", "field_409", "精英", "晨曦草原·精英关",
            "它转起来的时候，农民会跑出门喊‘要下雨啦’。"),
        Later("M410", "毒蘑菇集群", "field_410", "精英", "晨曦草原·精英关",
            "它们不是团结，只是互相挤得没法分开。"),
        Later("M411", "史莱姆王", "field_411", "首领", "晨曦草原·首领关",
            "普通史莱姆的梦想是变大，它的梦想是学会减肥。"),
        Later("M412", "平原巨像", "field_412", "首领", "晨曦草原·首领关",
            "农民以为它是山神，后来发现它只是迷路了。"),
    ...
    public static readonly MercEntry[] Mercs =
    {
        ...
        Hire("H009", "莫丁", "碎岩", "kuangzhan201", "狂战士", "累计通关裂隙 20 次后开放招募", "酒馆",
        ...
        Hire("H013", "莫娜", "紫晶", "naima201", "雷系法师", "累计进入裂隙 30 次后开放招募", "酒馆",
        ...
        Hire("H022", "索尔", "铁面", "zhongzhan201", "重武者", "累计通关裂隙 25 次后开放招募", "酒馆",
    ...
    public static readonly WorldEntry[] World =
    {
        W("W001", "埃索斯大陆", "世界观", "首次进入游戏",
            ...
            "世界不是平的，是裂开的。"),
        W("W002", "裂隙", "世界观", "首次进入战斗",
            "连接异世界的空间裂口，越往深处越危险。",
            "裂隙不是门，是伤口。每次有人跳进去，伤口就痒一下。"),
        W("W003", "皇家冒险者公会", "组织", "进入城镇后解锁",
            "表面上保护王国，实际上高层知晓裂隙真相并牺牲优秀冒险者以延缓裂隙扩张。",
            "公会大厅灯火通明，像是什么都没发生过。"),
        W("W004", "暮影森林", "地点", "进入第一章后解锁",
            "新人练手的第一处裂隙层，森林因裂隙能量而扭曲。",
            "这里的树会动，只是动作很慢，慢到你以为只是风吹。"),
        W("W005", "仙泉", "地点", "首次进入恢复关",
            "裂隙中偶尔出现的恢复节点，能恢复冒险者生命。",
            "仙泉不治病，它只借给你一点命，记得还。"),
    ...
    public static readonly StoryEntry[] Main =
    {
        ...
        new StoryEntry
        {
            ...
            Summary = "穿过浆果怪聚集区与森林史莱姆湿地，老盾在营地休息时提起自己第一次下裂隙的糗事。",
            Extra = "我第一次下裂隙，比你还紧张。至少你没把火把扔进蘑菇堆。"
        },
        new StoryEntry
        {
        ...
        new StoryEntry
        {
            ...
            Summary = "石碑后方正是森之守护者栖身地。击败首领后，森林暂时恢复平静，但裂隙的躁动并未停止。",
    ...
    public static readonly StoryEntry[] Side =
    {
        ...
        new StoryEntry
        {
            ...
            Summary = "咨询台小姐欲言又止，暗示森林层的任务并不只是“清理怪物”，有人在借委托之名掩盖裂隙扩张。",
            Extra = "奖励：天赋石 ×1"
        },
        new StoryEntry
        {
            Id = "S003", Title = "格雷的笔记", Unlock = "在暮影森林精英关概率掉落",
            Summary = "捡到一本破损的猎人笔记，署名格雷，记录了对裂隙异常的观察：怪物躁动、符文发光、有人深入裂隙未归。",
            Extra = "奖励：强化石 ×8"
        },
        new StoryEntry
        {
        ...
        new StoryEntry
        {
            Id = "S016", Title = "最初的裂隙", Unlock = "通关第一章噩梦难度后解锁",
    ...
    public static bool MercUnlocked(MercEntry e)
    {
        ...
        if (e.Id == "H011") return StoryProgress.TutorialBattleCleared || StoryProgress.TutorialDone || HasMerc("naima101");
    ...
    static MonsterEntry Later(string id, string name, string asset, string kind, string place, string lore)
    {
        ...
        {
            Id = id, Name = name, AssetId = asset, Kind = kind, Place = place,
            Unlock = "后续裂隙层", Desc = "在后续裂隙层中可解锁。", Lore = lore, LaterChapter = true
        };
    }
