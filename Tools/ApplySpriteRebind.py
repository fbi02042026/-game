...
def pick_image(node_path):
    ...
    if last == "空星":
        return "Assets/Art/UI/Common/空星.png"
    if last in ("满星1", "满星2", "满星3"):
        return "Assets/Art/UI/Common/满星.png"
    if last in ("RefreshBtn", "EnterRiftBtn"):
        return "Assets/Art/UI/Common/确定按钮.png"
    if last in ("JobCard0", "JobCard1", "JobCard2"):
        return "Assets/Art/UI/Main/主界面_0002s_0001_图标底.png"
    if last == "Frame" and parent.startswith("JobCard"):
        return "Assets/Art/UI/装备格子/frame_common.png"
    if last == "Panel":
        return "Assets/Art/UI/battle/大边框.png"
    return None   # Icon（运行时代码赋值）/ Dim（纯色遮罩）等，跳过
